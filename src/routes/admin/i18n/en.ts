...
export const en = {
  ...
  'dashboard.indexables': '{count} indexable',
  ...
  'media.title': 'Media',
  'media.lead': 'Upload and manage media for your site — images, video, audio and documents.',
  'media.dropzoneLabel': 'Drag & drop files here',
  'media.dropzoneHint': 'or use the button below',
  'media.chooseFile': 'Choose file',
  'media.dropzoneAriaLabel': 'File upload drop zone',
  'media.chooseFileAriaLabel': 'Choose file to upload',
  'media.fileInputAriaLabel': 'Upload media file',
  'media.searchLabel': 'Search assets by filename',
  'media.searchPlaceholder': 'Search by filename…',
  'media.searchAriaLabel': 'Search assets by filename',
  ...
  'media.noMatchTitle': 'No matching assets',
  'media.noMatchText': 'Try a different search term.',
  'media.countOf': '{shown} of {total} assets',
  'media.count': '{total} asset',
  'media.countPlural': '{total} assets',
  ...
  'blockForm.pickerTitleImage': 'Choose image',
  'blockForm.pickerTitleFile': 'Choose media',
  'blockForm.pickerAriaLabelImage': 'Choose image',
  'blockForm.pickerAriaLabelFile': 'Choose media',
  'blockForm.pickerCloseImage': 'Close image picker',
  'blockForm.pickerCloseFile': 'Close media picker',
  'blockForm.pickerLoading': 'Loading assets…',
  'blockForm.pickerSearchLabel': 'Search assets by filename',
  'blockForm.pickerSearchPlaceholder': 'Search by filename…',
  'blockForm.pickerSearchAriaLabel': 'Search assets by filename',
  'blockForm.pickerUploadLabel': 'Upload new asset',
  'blockForm.pickerChooseFile': 'Choose file',
  'blockForm.pickerNoFileSelected': 'No file selected',
  'blockForm.pickerUpload': 'Upload',
  'blockForm.pickerEmpty': 'No assets yet.',
  'blockForm.pickerCountOf': '{shown} of {total} assets',
  'blockForm.pickerCount0': '0 assets',
  ...
  'blockForm.pickerLoadError': 'Failed to load assets.',
  ...
  'errors.loadDashboardFailed': 'Failed to load the dashboard.',
