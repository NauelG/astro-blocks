...
export const es = {
  ...
  'blockForm.pickerLoading': 'Cargando imágenes…',
  'blockForm.pickerSearchLabel': 'Buscar imágenes por nombre de archivo',
  'blockForm.pickerSearchPlaceholder': 'Buscar por nombre de archivo…',
  'blockForm.pickerSearchAriaLabel': 'Buscar imágenes por nombre de archivo',
  'blockForm.pickerUploadLabel': 'Subir nueva imagen',
  ...
  'blockForm.pickerEmpty': 'Aún no hay imágenes.',
  'blockForm.pickerCountOf': '{shown} de {total} imágenes',
  'blockForm.pickerCount0': '0 imágenes',
  ...
  'blockForm.imageLoadError': 'Error al cargar imágenes.',
