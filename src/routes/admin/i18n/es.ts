...
export const es = {
  ...
  'media.dropzoneAriaLabel': 'Zona de carga de imágenes',
  'media.chooseImageAriaLabel': 'Elegir imagen para subir',
  'media.fileInputAriaLabel': 'Subir archivo de imagen',
  'media.searchLabel': 'Buscar imágenes por nombre de archivo',
  'media.searchPlaceholder': 'Buscar por nombre de archivo…',
  'media.searchAriaLabel': 'Buscar imágenes por nombre de archivo',
  'media.prevPage': 'Página anterior',
  'media.nextPage': 'Página siguiente',
  'media.prevBtn': 'Ant.',
  'media.nextBtn': 'Sig.',
  'media.imageLibraryAriaLabel': 'Biblioteca de imágenes',
  'media.imageMetaAriaLabel': 'Metadatos de imagen',
  'media.empty.title': 'Aún no hay imágenes subidas',
  'media.empty.text': 'Sube tu primera imagen usando el área de arriba.',
  'media.noMatchTitle': 'Sin imágenes coincidentes',
  'media.noMatchText': 'Prueba con otro término de búsqueda.',
  'media.countOf': '{shown} de {total} imágenes',
  'media.count': '{total} imagen',
  'media.countPlural': '{total} imágenes',
  'media.pageIndicator': 'Página {page} de {totalPages}',
  'media.uploadSuccess': 'Subida correcta',
  'media.uploadSuccessMessage': '{filename} subida.',
  ...
  'media.deleted': 'Eliminada',
  'media.deletedMessage': '{filename} eliminada.',
  'media.deleteFailed': 'Error al eliminar',
  'media.deleteFailedMessage': 'No se pudo eliminar la imagen.',
  'media.replacing': 'Reemplazando…',
  'media.replacingMessage': 'Procesando {filename}',
  'media.replaceSuccess': 'Reemplazo correcto',
  'media.replaceSuccessMessage': '{filename} reemplazada. Regenerando variantes.',
  ...
  'blockForm.pickerUploadSuccessMsg': '{filename} subida.',
