...
export const es = {
  ...
  'pageEditor.labelNofollow': 'Añadir nofollow',
  ...
  'languages.codeRequired': 'El código de idioma es obligatorio.',
  ...
  'globalBlocks.info': 'Los slugs se declaran en astro.config.mjs mediante la opción globalBlocks. Para añadir o eliminar slugs, modificá la configuración del proyecto y volvé a hacer build.',
  ...
  'globalBlocks.empty.text': 'Declarà slugs en globalBlocks dentro de tu astro.config.mjs y volvé a hacer build para empezar.',
  'globalBlocks.schemaNotFound': 'No se encontró el esquema para "{name}". Verificá la configuración.',
  'globalBlocks.saved': 'Bloque global guardado correctamente.',
  'globalBlocks.savedTitle': 'Bloques globales',
  'globalBlocks.networkError': 'Error de red al guardar. Revisá la conexión.',
